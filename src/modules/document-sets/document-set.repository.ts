...
//
// FLAGGED, RENAMED — session 55 (tsc fix): this file was renamed from
// document-sets.repository.ts to document-set.repository.ts (singular)
// to match the import path already used by document-set.factory.ts and
// document-set.service.ts, resolving the "Cannot find module
// './document-set.repository'" error in both of those files. Contents
// unchanged aside from that rename and the one-line import fix below.
//
